...
public class DrawingExample extends JComponent {
    ...
    //blue, green, red 
    Color purple = new Color(114, 13, 58);
    int pacmanX = 50;
    //+1 - Right 
    //-1 - Left 
    ...
    public void paintComponent(Graphics g) {
        ...
        //rectangle
        //colour is set at red 
        g.setColor(Color.blue);
        //draw a rectangle at (400,300) that is 100 wide and 50 tall
        g.fillRect(400, 300, 100, 50);
        //set colour of oval to pink 
        ...
        //set colour of triangle to green 
        g.setColor(purple);
        //x position and then y position and how many points there are
        g.fillPolygon(xPoints, yPoints, 3);
        
        //arc(pac man) 
        g.setColor(Color.YELLOW);
        //45 is what angle you want to start at
        //270 is how much you want to rotate from 45
    ...
    public void run() {
        ...
        while (!done) {
            ...
            //if pacman is less then 75 then it stops at 75
            if(pacmanX > WIDTH - 75) {
               pacmanDirection = -1; 
            }
            ...
            pacmanX = pacmanX + pacmanDirection*30;
